import type { ColorTheme, RadiusPreset, FontFamily } from "./types"
...
export function getColorThemePalette(colorTheme: ColorTheme): { light: Record<string, string>; dark: Record<string, string> } {
