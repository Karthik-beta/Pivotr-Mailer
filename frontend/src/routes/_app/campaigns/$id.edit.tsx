            ...
            >
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button asChild>
                            <Link to="/campaigns" search={{ status: 'all' }}>Back to Campaigns</Link>
                        </Button>
                    </div>
                </div>
            </Layout>
            ...
            >
                <div className="space-y-6">
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            This campaign is in <strong>{campaign.status}</strong> status and cannot
                            be edited. Only campaigns in DRAFT status can be modified.
                        </AlertDescription>
                    </Alert>
                    <Button asChild>
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Modify your campaign settings. Changes can only be made while in DRAFT
                        status.
                    </p>
                </div>
