...
import { CheckCircle2, Eye, Send, Users } from "lucide-react";
			...
			<Tabs defaultValue="overview">
				...
				<TabsContent value="overview" className="space-y-6 mt-6">
					...
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						...
						<MetricCard
							...
							gradient="green"
							percentage={
								metrics && metrics.sent > 0 ? (metrics.delivered / metrics.sent) * 100 : 0
							}
						/>
						<MetricCard
							title="Opened"
							...
							gradient="blue"
							percentage={
								metrics && metrics.delivered > 0 ? (metrics.opened / metrics.delivered) * 100 : 0
							}
						/>
					</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						...
						<Card>
							<CardHeader className="pb-2">
								<CardTitle className="text-sm font-mono uppercase">Email Template</CardTitle>
							</CardHeader>
							<CardContent>
								{campaign.template ? (
						...
						<Card>
							<CardHeader className="pb-2">
								<CardTitle className="text-sm font-mono uppercase">Delay Configuration</CardTitle>
							</CardHeader>
							<CardContent>
								{campaign.delayConfig ? (
									...
									<p className="text-sm text-muted-foreground">No delay configuration</p>
								)}
							</CardContent>
						</Card>
					</div>
				...
				<TabsContent value="schedule" className="mt-6">
					{campaign.schedule ? (
						...
						<Card>
							<CardContent className="py-8 text-center">
								<p className="text-muted-foreground">No schedule configured for this campaign.</p>
							</CardContent>
						</Card>
					)}
				</TabsContent>
