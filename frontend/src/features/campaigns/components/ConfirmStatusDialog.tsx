...
> = {
    start: {
        ...
        description: 'This will begin sending emails to the assigned leads. Make sure your email template is ready.',
    ...
    abort: {
        ...
        description: 'This will permanently stop the campaign. This action cannot be undone and any remaining leads will not be sent.',
