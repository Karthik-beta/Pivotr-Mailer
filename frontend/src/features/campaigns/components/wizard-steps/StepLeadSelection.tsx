...
export function StepLeadSelection({ data, onChange, errors }: StepLeadSelectionProps) {
    ...
    }, [data.leadSelection.leadTypes, data.leadSelection.statuses]);
    ...
    return (
        <div className="space-y-6">
            <p className="text-sm text-muted-foreground">
                Select the criteria for leads to include in this campaign. Only leads matching all
                selected criteria will be targeted.
            </p>
                        ...
                        <div key={value} className="flex items-center gap-2">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) =>
                                    toggleLeadType(value, checked as boolean)
                                }
                            />
                        ...
                        <table className="w-full text-sm">
                            <thead className="bg-muted">
                                <tr>
                                    ...
                                    <th className="px-4 py-2 text-left font-mono text-xs">
                                        Company
                                    </th>
