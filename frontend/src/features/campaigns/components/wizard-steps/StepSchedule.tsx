...
export function StepSchedule({ data, onChange, errors }: StepScheduleProps) {
    ...
    const updateWorkingHours = (field: 'startHour' | 'startMinute' | 'endHour' | 'endMinute', value: number) => {
        onChange({
            schedule: {
                ...data.schedule,
                workingHours: {
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) => updatePeakHours('startHour', parseInt(value))}
                        >
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) => updatePeakHours('endHour', parseInt(value))}
                        >
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => updateSchedule('dailyLimit', parseInt(e.target.value) || 500)}
                    />
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) => updateSchedule('batchSize', parseInt(e.target.value) || 50)}
                    />
