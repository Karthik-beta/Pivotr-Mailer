...
import { FileText, Mail, Calendar, Clock, Users, AlertTriangle } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <p className="text-sm text-muted-foreground">
                Review your campaign settings before creating. You can edit these later while the
                ...
                <Card className="md:col-span-2 bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 border-emerald-200 dark:border-emerald-800">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                            ...
                            {data.leadSelection.statuses.join(', ')}
                        </p>
                    </CardContent>
                </Card>
            </div>
