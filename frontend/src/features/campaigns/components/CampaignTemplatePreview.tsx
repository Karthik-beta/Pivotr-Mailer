		...
		<div className="space-y-6">
			...
			<Card className="bg-muted/50">
				<CardHeader className="pb-2 border-b space-y-1">
					...
					{template.ccEmail && (
						<div className="font-mono text-xs text-muted-foreground">CC: {template.ccEmail}</div>
					)}
			...
			<p className="text-xs text-muted-foreground">
				Note: The subject and body may contain Spintax (e.g., {"{Hi|Hello}"}) which will be randomly
				resolved when sending. Variables like {"{{FirstName}}"} will be replaced with lead data.
			</p>
		</div>
	);
}
