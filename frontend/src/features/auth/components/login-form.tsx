	...
	return (
		<Card className="w-full max-w-sm border-2 border-border shadow-lg">
			<CardHeader className="space-y-1 pb-4">
				<CardTitle className="text-2xl font-bold font-mono tracking-tight text-center uppercase">
					Pivotr Mailer
				</CardTitle>
			...
			<CardContent className="space-y-4">
				...
				<div className="relative">
					...
					<div className="relative flex justify-center text-xs uppercase">
						<span className="bg-card px-2 text-muted-foreground font-mono">Authentication</span>
					</div>
				</div>
				...
				<Button
					variant="outline"
					className="w-full h-12 font-medium border-2 hover:bg-accent transition-colors"
