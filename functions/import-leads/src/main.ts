...
// Shared modules
import { findLeadByEmail, createLead } from '../../_shared/database/repositories/lead.repository';
import { logInfo, logError } from '../../_shared/database/repositories/log.repository';
...
export default async function main(context: AppwriteContext): Promise<unknown> {
    ...
    try {
        ...
        await logInfo(client, EventType.LEAD_IMPORTED,
