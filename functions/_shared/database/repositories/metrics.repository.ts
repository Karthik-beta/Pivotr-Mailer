...
import type { Metrics, MetricsIncrementInput } from '../../../../shared/types/metrics.types';
...
export async function incrementMetrics(
    ...
    if (increments.totalVerificationPassed) {
        updates.totalVerificationPassed = current.totalVerificationPassed + increments.totalVerificationPassed;
    }
    if (increments.totalVerificationFailed) {
        updates.totalVerificationFailed = current.totalVerificationFailed + increments.totalVerificationFailed;
    }
